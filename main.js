...
import {registerTabFolders, registerCompendiumFolderImport} from "./tab-folders.js";
import {registerInventoryFolders} from "./inventory-folders.js";
import {registerItemMods} from "./item-mods.js";
import {registerActionFolders} from "./action-folders.js";
import {registerSectionSearch} from "./section-search.js";
...
Hooks.once("init", () => {
  ...
  game.settings.register(MODULE_ID, "enableSearch", {
    name: "SR5CF.Settings.EnableSearch",
    hint: "SR5CF.Settings.EnableSearchHint",
    scope: "world",
    config: true,
    type: Boolean,
    default: true,
  ...
  // Per-user collapse state for compendium-mirrored action folders.
  game.settings.register(MODULE_ID, "actionFolderCollapse", {
    scope: "client",
    config: false,
    type: Object,
    default: {},
  ...
  registerTabFolders();
  registerInventoryFolders();
  registerItemMods();
  registerCompendiumFolderImport();
  registerActionFolders();
  registerSectionSearch();
});
